...
public class Rpt_Patients {
    ...
    public void CallRPTListPatient() {
        try {
            String master = System.getProperty("user.dir") + "\\src\\WIN35CLC_REPORTS\\rpt_patients.jasper";
