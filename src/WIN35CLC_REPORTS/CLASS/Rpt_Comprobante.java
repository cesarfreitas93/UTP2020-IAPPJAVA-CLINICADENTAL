...
public class Rpt_Comprobante {
    ...
    public Rpt_Comprobante() throws IOException {
        try {
    ...
    public void CallExplorerRPT(long id_comp,long id_pat, String tipo) {
        try {
            String master = System.getProperty("user.dir") + "\\src\\WIN35CLC_REPORTS\\rpt_comprobante.jasper";
...
//            InputStream stream2 = this.getClass().getResourceAsStream("\\src\\reportes\\repoteListaPacientes.jasper");//aquí le pones la ruta de tu reporte
            ...
            parametro.put("id_comp", (int) id_comp);
            parametro.put("id_pat", (int) id_pat);
