...
public class UI_v5_save extends javax.swing.JFrame {
...
changeimage_button(btn_max, "/WIN34CLC_RESOURCES_UI/max.png");   
 ...
 if(maximized){
            ...
            UI_v5_save.this.setExtendedState(JFrame.MAXIMIZED_BOTH);
            GraphicsEnvironment env = GraphicsEnvironment.getLocalGraphicsEnvironment();
            UI_v5_save.this.setMaximizedBounds(env.getMaximumWindowBounds());
            maximized = false;
        }else{
...
subboton_vaciar_bd();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_v5_save().setVisible(true);
            }
        });
    }
