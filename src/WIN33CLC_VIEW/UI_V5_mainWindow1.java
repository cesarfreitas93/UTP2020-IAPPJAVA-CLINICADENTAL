...
public class UI_V5_mainWindow1 extends javax.swing.JFrame {
 static boolean maximized = true;

boolean a=true;


    public UI_V5_mainWindow1() {
...
changeimage_button(btn_max, "/WIN34CLC_RESOURCES_UI/max.png");   
 ...
 if(maximized){
            ...
            UI_V5_mainWindow1.this.setExtendedState(JFrame.MAXIMIZED_BOTH);
            GraphicsEnvironment env = GraphicsEnvironment.getLocalGraphicsEnvironment();
            UI_V5_mainWindow1.this.setMaximizedBounds(env.getMaximumWindowBounds());
            maximized = false;
        }else{
...
this.setState(Frame.ICONIFIED);          
    ...
    private void btn_createbackupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_createbackupActionPerformed
     try {
         ...
         Logger.getLogger(UI_V5_mainWindow1.class.getName()).log(Level.SEVERE, null, ex);
     }
  ...
  subboton_vaciar_bd();       
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_V5_mainWindow1().setVisible(true);
            }
        });
    }
