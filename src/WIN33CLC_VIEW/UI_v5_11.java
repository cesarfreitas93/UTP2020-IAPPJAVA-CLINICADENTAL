...
public class UI_v5_11 extends javax.swing.JFrame {
...
boolean a=true;
    ...
    public UI_v5_11() {
       ...
       rSPanelsSlider1.setBackground(new Color (255,255,255,255));
    ...
    private void initComponents() {
        ...
        rSPanelsSlider1.add(panel_cita, "card3");
        ...
        rSPanelsSlider1.add(panel_comprobante, "card3");
        ...
        rSPanelsSlider1.add(panel_servicios, "card3");
        ...
        rSPanelsSlider1.add(panel_usuarios, "card3");
     ...
     public void boton_inicio()
    {
        ...
        if(!this.btn_inicio.isSelected()){
           ...
           frm_UI_inicio2.ocultar_form_inicio(true);
            ...
            rSPanelsSlider1.slidPanel(1, panel_inicio, RSPanelsSlider.direct.Right);
            //rSPanelsSlider1.slidPanel(panel_inicio, RSPanelsSlider.direct.Right);
    ...
    public void boton_paciente()
    {
        ...
        if(!this.btn_paciente.isSelected()){
           ...
           frm_UI_inicio2.ocultar_form_inicio(false);
            ...
            rSPanelsSlider1.slidPanel(1, panel_paciente, RSPanelsSlider.direct.Right);
           // rSPanelsSlider1.slidPanel(panel_paciente, RSPanelsSlider.direct.Right);
     ...
     public void boton_cita()
    {
        ...
        if(!this.btn_cita.isSelected()){
           ...
           frm_UI_inicio2.ocultar_form_inicio(false);
             ...
             rSPanelsSlider1.slidPanel(1, panel_cita, RSPanelsSlider.direct.Right);
              
             //rSPanelsSlider1.slidPanel(panel_cita, RSPanelsSlider.direct.Right);
    ...
    public void boton_gestionarCita()
    {
        if(!this.btn_gestionar_cita.isSelected()){
            ...
            rSPanelsSlider1.slidPanel(1, panel_gestion_cita, RSPanelsSlider.direct.Right);
        }
    ...
    public void boton_comprobante()
    {
         ...
         if(!this.btn_factura.isSelected()){
           ...
           frm_UI_inicio2.ocultar_form_inicio(false);
             ...
             rSPanelsSlider1.slidPanel(1, panel_comprobante, RSPanelsSlider.direct.Right);
         }
    ...
    public void boton_servicios()
    {
        ...
        if(!this.btn_servicios.isSelected()){
           ...
           frm_UI_inicio2.ocultar_form_inicio(false);
            ...
            rSPanelsSlider1.slidPanel(1,panel_servicios, RSPanelsSlider.direct.Right);
     ...
     public void boton_especialistas()
    {
        ...
        if(!this.btn_especialista.isSelected()){
           ...
           frm_UI_inicio2.ocultar_form_inicio(false);
            ...
            rSPanelsSlider1.slidPanel(1,panel_especialista, RSPanelsSlider.direct.Right);
        }
        lblinicio.setBackground(new Color(255,255,255));
        lblpacientes.setBackground(new Color(255,255,255));
        lblcita.setBackground(new Color(255,255,255));
     ...
     public void boton_usuarios()
    {
        ...
        if(!this.btn_usuario.isSelected()){
           ...
           frm_UI_inicio2.ocultar_form_inicio(false);
            ...
            rSPanelsSlider1.slidPanel(1,panel_usuarios, RSPanelsSlider.direct.Right);
        }
        lblinicio.setBackground(new Color(255,255,255));
        lblpacientes.setBackground(new Color(255,255,255));
        lblcita.setBackground(new Color(255,255,255));
...
this.setState(Frame.ICONIFIED);         // TODO add your handling code here:
 ...
 if(maximized){
            ...
            UI_v5_11.this.setExtendedState(JFrame.MAXIMIZED_BOTH);
            GraphicsEnvironment env = GraphicsEnvironment.getLocalGraphicsEnvironment();
            UI_v5_11.this.setMaximizedBounds(env.getMaximumWindowBounds());
            maximized = false;
        }else{
