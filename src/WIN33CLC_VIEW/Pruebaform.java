...
int xx,xy;
    ...
    private void initComponents() {
        ...
        rSPanelImage1.setImagen(new javax.swing.ImageIcon(getClass().getResource("/WIN34CLC_RESOURCES_UI/f01.jpg"))); // NOI18N
...
changeimage_button(btn_max, "/WIN34CLC_RESOURCES_UI/max.png");   
 ...
 if(maximized){
            ...
            Pruebaform.this.setExtendedState(JFrame.MAXIMIZED_BOTH);
            GraphicsEnvironment env = GraphicsEnvironment.getLocalGraphicsEnvironment();
            Pruebaform.this.setMaximizedBounds(env.getMaximumWindowBounds());
            maximized = false;
        }else{
